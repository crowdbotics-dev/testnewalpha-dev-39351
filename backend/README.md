...
## Project Structure
    ...
    ├── testnewalpha_dev_39351  # Django project configurations
...
1. Clone this repo and `cd testnewalpha_dev_39351`
...
2. Clone this repo and `cd testnewalpha_dev_39351`
